...
def demo_run():
    ...
    take_weights_here = {}
    exec(open(os.path.dirname(__file__) + "/RoboschoolHumanoidFlagrunHarder_v1_2017jul.weights").read(), take_weights_here)
    pi = ZooPolicyTensorflow("mymodel1", env.observation_space, env.action_space, take_weights_here)
