...
class RoboschoolAtlasForwardWalk(RoboschoolForwardWalker, RoboschoolUrdfEnv):
    ...
    def alive_bonus(self, z, pitch):
        ...
        #self._test = self.scene.cpp_world.debug_sphere(x, y, z, 0.2, 0xFF8080)
        return +4 if z > 1.3 else -1
